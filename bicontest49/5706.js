 ...
 */
 var areSentencesSimilar = function(sentence1, sentence2) {
    ...
    const shorter = (sentence1Array.length < sentence2Array.length) ? sentence1Array : sentence2Array;
    const longer = (sentence1Array.length > sentence2Array.length) ? sentence1Array : sentence2Array;
...
console.log(areSentencesSimilar("Luky",
"Lucccky"))